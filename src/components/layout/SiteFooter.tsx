...
export const SiteFooter: React.FC = () => (
  <footer className="bg-[#0B1E2F] text-[#A9BDD0] pt-16 pb-7">
    <div className="max-w-7xl mx-auto px-6">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-[1.4fr_1fr_1fr_1.2fr] gap-10 mb-11">
        {/* Brand */}
        <div>
          <Link to="/" className="flex items-center gap-3">
            <span className="w-11 h-11 rounded-xl grid place-items-center text-white" style={{ background: "linear-gradient(140deg,#102A43,#2878B5)" }}>
            ...
            <span className="leading-tight">
              ...
              <span className="block text-[11px] text-[#A9BDD0]">Dental Care Multispeciality</span>
            </span>
          </Link>
      ...
      <div className="border-t border-white/10 pt-6">
        <p className="text-[13px] text-[#8298AD] leading-relaxed">
